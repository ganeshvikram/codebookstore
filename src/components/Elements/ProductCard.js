    ...
    <div className="m-3 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        <Link to={`/products/${id}` }>
            <div className="relative" >
                {best_seller && <span className="absolute top-4 left-4 px-2 bg-orange-500 bg-opacity-90 text-white rounded">Best Seller</span>}
        ...
        <div className="p-5">
            ...
            <p className="flex justify-between items-center">
                ...
                <button
                    ...
                    ${product.in_stock ? 'hover:bg-blue-800' : 'opacity-50 cursor-not-allowed'}`}
