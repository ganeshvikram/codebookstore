...
export const FilterBar = ({setShow}) => {
 ...
 const {state,dispatch} = useFilter();
  ...
  return (
    <section className="filter text-left">
                ...
                <ul className="text-slate-700 dark:text-slate-100">
                  <li className="mt-1 mb-5">
                    ...
                    <div className="flex items-center my-1">
                        <input  id="price-sort-1" onChange={()=>dispatch({type:"SHORT_BY", payload:{shortBy: "lowtohigh"}})} checked={state.shortBy==='lowtohigh' || false}  type="radio" value="" name="price-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                        <label htmlFor="price-sort-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Price - Low to High</label>
                    </div>
                    <div className="flex items-center my-1">
                        <input id="price-sort-2" onChange={()=>dispatch({type:"SHORT_BY", payload:{shortBy: "hightolow"}})} checked={state.shortBy==='hightolow' || false}  type="radio" value="" name="price-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                  ...
                  <li className="mt-1 mb-5">
                    ...
                    <div className="flex items-center my-1">
                        <input id="rating-sort-1" onChange={()=>dispatch({type:"RATTINGS", payload:{rating: "4STARABOVE"}})} checked={state.rating==='4STARABOVE' || false} type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                        <label htmlFor="rating-sort-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">4 Stars & Above</label>
                    </div>
                    <div className="flex items-center my-1">
                        <input id="rating-sort-2" onChange={()=>dispatch({type:"RATTINGS", payload:{rating: "3STARABOVE"}})} checked={state.rating==='2STARABOVE' || false} type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                        <label htmlFor="rating-sort-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">3 Stars & Above</label>
                    </div>
                    <div className="flex items-center my-1">
                        <input id="rating-sort-3" onChange={()=>dispatch({type:"RATTINGS", payload:{rating: "2STARABOVE"}})}  checked={state.rating==='3STARABOVE' || false} type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                        <label htmlFor="rating-sort-3" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">2 Stars & Above</label>
                    </div>
                    <div className="flex items-center my-1">
                        <input id="rating-sort-4" onChange={()=>dispatch({type:"RATTINGS", payload:{rating: "1STARABOVE"}})}  checked={state.rating==='1STARABOVE' || false}  type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
